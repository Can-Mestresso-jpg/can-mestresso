        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          ...
          <div className="mb-16 text-center">
            ...
            <h2 className="mt-4 text-4xl font-light sm:text-5xl lg:text-6xl">
              Explore Can Mestresso
            </h2>

            <p className="mx-auto mt-6 max-w-2xl text-gray-600">
              Discover every corner of the villa, from peaceful outdoor spaces
              to elegant Mediterranean interiors.
            </p>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            {gallery.map((image, i) => (
              ...
              >
                ...
                <div className="absolute bottom-6 left-6 translate-y-4 text-white opacity-0 transition duration-500 group-hover:translate-y-0 group-hover:opacity-100">
